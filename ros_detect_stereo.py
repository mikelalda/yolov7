...
class ObjectDetection(Node):
    def __init__(self):
        ...
        self.get_logger().info("weights: %s, topic_left: %s, topic_right: %s, det_conf_thres: %s, conf_thres: %s, iou_thres: %s, device: %s, img_size: %s, inf_image: %s, inf_left_image_topic: %s, bbox_left_topic: %s, inf_right_image_topic: %s, bbox_right_topic: %s, frequency: %s, is_seg: %s" %
                    (str(self.weights),
                        str(self.topic_left),
